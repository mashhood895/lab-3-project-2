          ...
          <li class="item">
            ...
            <div class="content">
              ...
              <div class="extra">
                ...
                <a class="ui icon button" href="addToFavorites.php?paintid=<?php echo $work['PaintingID']; ?>&paintfile=<?php echo $work['ImageFileName']; ?>&paintTitle=<?php echo $work['Title']; ?>"><i class="heart icon"></i></a>          
              </div>        
            </div>      
          </li>
          <?php } ?>
