<div class="ui segment">
    ...
    <a href="addToFavorites.php?paintid=<?php echo $row['PaintingID']; ?>&paintfile=<?php echo $row['ImageFileName']; ?>&paintTitle=<?php echo $row['Title']; ?>"class="ui right labeled icon button">
