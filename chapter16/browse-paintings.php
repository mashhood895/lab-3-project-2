          ...
          <li class="item">
            ...
            <div class="content">
              ...
              <div class="extra">
                ...
                <a class="ui icon button" href="addToFavorites.php?id=<?php echo $work['PaintingID']; ?>&title=<?php echo $work['Title']; ?>&file=<?php echo $work['ImageFileName']; ?>"><i class="heart icon"></i></a>          
              </div>        
            </div>      
          </li>
