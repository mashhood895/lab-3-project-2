...
<main class="ui segment doubling stackable grid container">
	...
	<table class="ui definition very basic collapsing celled table">
		...
		<tbody>
		<?php if(isset($_SESSION['paintingID'])) {
			for($a = 0; $a < count($_SESSION['paintingID']); $a++) {
				?>
				<tr> 
					<td><a class="ui small image" href="single-painting.php?id=<?php echo $_SESSION['paintingID'][$a]; ?>"><img src="images/art/works/square-medium/<?php echo $_SESSION['fileName'][$a]; ?>.jpg"></a></td>
					<td> <a class="header" href="single-painting.php?id=<?php echo $_SESSION['paintingID'][$a]; ?>"><?php echo utf8_encode($_SESSION['Title'][$a]); ?></a></td>
					<td><a href="remove-favorites.php?id=<?php echo $_SESSION['paintingID'][$a]; ?>&action=singleFavorite"class="ui right  icon button"> Remove </a> </td>
				</tr>
				<?php
			}
		} ?>
		...
		<tfoot>
			<tr>
				<td colspan="3"><td><a href="remove-favorites.php?action=removeAllFavourites"class="ui labeled icon blue button"> <i class="trash icon"></i>Remove All Favorites </a> </td></td>
			</tr>
		</tfoot>
	</table>
	</section>  
